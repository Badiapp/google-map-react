  ...
  return (function(e) {
      ...
      var s = Object.assign ||
        ...
        y = (function(e) {
          function t(e) {
                    ...
                    (c.default.Children.forEach(
                      ...
                      function(r, i) {
                        if (
                          ...
                          s < o && t.push({ key: a, dist: s, props: r.props });
                        }
                      }
                    ), t.length)
                  ) {
            ...
            }), (n.hoverKey_ = null), (n.hoverChildProps_ = null), (n.allowMouse_ = !0), (n.state = s(
              {},
              n._getState(),
              { hoverKey: null }
            )), n;
    ...
    function(e, t, n) {
      ...
      (a.convert = function(e) {
        return e instanceof a
          ...
          : Array.isArray(e)
              ? new a(e[0], e[1])
              : 'lng' in e && 'lat' in e ? new a(e.lat, e.lng) : e;
      }), (t.default = a);
    },
    function(e, t) {
      'use strict';
    ...
    function(e, t, n) {
            ...
            if (
              ((n._getMinZoom = function() {
                if (
                  ...
                  var e = Math.ceil(n.geoService_.getWidth() / X) + 2,
                    t = Math.ceil(n.geoService_.getHeight() / X) + 2,
                    o = Math.max(e, t);
                  ...
                  n.props
                    ...
                    .then(function(e) {
                      if (n.mounted_) {
                          ...
                          g = Object.assign(new e.OverlayView(), {
                            ...
                            draw: function() {
                              var t = g.div,
                                ...
                                r = o.getNorthEast(),
                                i = o.getSouthWest(),
                                a = n.fromLatLngToDivPixel(
                                  new e.LatLng(r.lat(), i.lng())
                                ),
                                s = (0, z.default)().isSafari
                              ...
                              _.updateCounter_++, _._onBoundsChanged(
                                ...
                                (_._onGoogleApiLoaded({
                                  map: h,
                                  maps: e,
                                }), (_.googleApiLoadedCalled_ = !0)), (t.style.left = s.x +
                                'px'), (t.style.top = s.y +
                        ...
                        (n.overlay_ = g), g.setMap(
                          ...
                          var o = g.div,
                            ...
                            u = r.fromLatLngToDivPixel(
                              new e.LatLng(a.lat(), s.lng())
                            ),
                            l = (0, z.default)().isSafari
                        ...
                        }), e.event.addListener(h, 'dragstart', function() {
                          _._onDragStart();
                ...
                var e;
                return n.props.onDragStart &&
                  (e = n.props).onDragStart.apply(e, arguments);
              }), (n._onDragEnd = function() {
                var e;
                return n.props.onDragEnd &&
                ...
                if (n.mouseInMap_) {
                  ...
                  var a = n.geoService_.unproject(n.mouse_, !0);
                  (n.mouse_.lat = a.lat), (n.mouse_.lng = a.lng), n._onChildMouseMove(), t -
                    n.dragTime_ <
                    Y
                ...
                if (
                  ...
                  if (!(0, P.default)(a, n.prevBounds_, V) && o !== !1) {
                    var u = n.geoService_.getBounds(n.props.margin);
                    n.props.onBoundsChange &&
                      n.props.onBoundsChange(
                        n.centerIsObject_ ? l({}, s) : [s.lat, s.lng],
                        i,
                        a,
                        u
                      ), n.props.onChange &&
                ...
                if (
                  ...
                  if (
                    ...
                    if (
                      ...
                      var s = this._computeMinZoom(
                        a.minZoomOverride,
                        a.minZoom
                      );
                      a.minZoom = te(a.minZoom, s);
                    }
      ...
      (ne.propTypes = {
        ...
        layerTypes: [],
      }), (ne.googleMapLoader = D.default), (t.default = ne);
    },
    function(e, t, n) {
      'use strict';
      function o(e) {
    ...
    function(e, t, n) {
      ...
      t.default = function(e) {
        return a.default.createElement(
          'div',
          { style: l },
          a.default.createElement(u.default, r({}, e, { prerender: !0 }))
        );
      };
      var i = n(1),
        a = o(i),
        ...
        var a = (function() {
          ...
          c = function(e) {
            ...
            u(this), this.__resizeRAF__ &&
              s(this.__resizeRAF__), (this.__resizeRAF__ = a(function() {
              l(t) &&
    ...
    function(e, t, n) {
      ...
      (r.prototype._events = void 0), (r.prototype.eventNames = function() {
        ...
        if (!o) return [];
        if (o.fn) return [o.fn];
        for (var r = 0, i = o.length, s = new Array(i); r < i; r++)
          s[r] = o[r].fn;
        return s;
        ...
        return this._events ||
          (this._events = a ? {} : Object.create(null)), this._events[i]
          ? this._events[i].fn
        ...
        return this._events
          ? (e
              ...
              : (this._events = a ? {} : Object.create(null)), this)
          : this;
	  ...
	  */
      !(function(i, a) {
        ...
        function o(e, t) {
          ...
          }))), (o.async = 1), (o.src = i ? e + (e.indexOf('?') === -1 ? '?' : '&') + i : e), s.insertBefore(o, s.lastChild);
        }
        var r,
          i,
          a = document,
