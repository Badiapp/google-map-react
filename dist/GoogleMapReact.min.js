  ...
  return (function(e) {
    ...
    function(e, t, n) {
          ...
          function t(n) {
            ...
            if (
              ((o._getMinZoom = function() {
                ...
                if (!o.initialized_) {
                  o.initialized_ = !0;
                  var e = te(o.props.center || o.props.defaultCenter);
                            ...
                            draw: function() {
                              ...
                              m.updateCounter_++, m._onBoundsChanged(
                                ...
                                (m._onGoogleApiLoaded({
                                  map: _,
                                  maps: e,
                                }), (m.googleApiLoadedCalled_ = !0)), (t.style.left = a.x +
                                'px'), (t.style.top = a.y +
                                'px'), m.markersDispatcher_ &&
                                m.markersDispatcher_.emit('kON_CHANGE');
                            },
                          });
                        (o.overlay_ = g), g.setMap(
                          _
                        ), o.props.heatmap.positions &&
                          o.heatmap.setMap(
                            _
                          ), e.event.addListener(_, 'zoom_changed', function() {
                          if (m.geoService_.getZoom() !== _.getZoom()) {
                            m.zoomAnimationInProgress_ ||
                              ((m.zoomAnimationInProgress_ = !0), m._onZoomAnimationStart());
                            var t = 300;
                            new Date().getTime() - o.zoomControlClickTime_ < t
                              ...
                              : (m.updateCounter_++, m._onBoundsChanged(_, e));
                          }
                          ...
                          if (
                            (m.zoomAnimationInProgress_ &&
                              ((m.zoomAnimationInProgress_ = !1), m._onZoomAnimationEnd()), m.updateCounter_++, m._onBoundsChanged(
                              _,
                              e
                            ), o.mouse_)
                          ) {
                          ...
                          o._onChildMouseMove(), (m.dragTime_ = 0);
                          var r = g.div, i = g.getProjection();
                          if (r && i) {
                            var s = _.getBounds(),
                              a = s.getNorthEast(),
                              u = s.getSouthWest(),
                              l = i.fromLatLngToDivPixel(
                                new e.LatLng(a.lat(), u.lng())
                              ),
                              p = (0, B.default)().isSafari
                                ? { x: Math.round(l.x), y: Math.round(l.y) }
                                : { x: l.x, y: l.y };
                            (r.style.left = p.x + 'px'), (r.style.top = p.y +
                              'px');
                          }
                          ...
                          'maptypeid_changed',
                          function() {
                            m._onMapTypeIdChange(_.getMapTypeId());
                          }
                        );
                      }
                    })
              ...
              var s = te(o.props.center || o.props.defaultCenter);
          ...
          return s(t, e), (t.prototype.componentDidMount = function() {
            ...
            if (
              ...
              if (
                ...
                var i = (0, T.default)(this.maps_, K.default),
            ...
            return !(0, U.default)(
              (0, A.default)(this.props, ['draggable']),
      ...
      (re.propTypes = {
        ...
        heatmap: {},
        heatmapLibrary: !1,
      }), (re.googleMapLoader = O.default), (t.default = re);
    },
    function(e, t, n) {
      'use strict';
      function o(e) {
    ...
    function(e, t, n) {
      ...
      var r = n(4),
        ...
        s = 'https://maps',
        a = s + '.googleapis.com',
        u = '/maps/api/js?callback=_$_google_map_initialize_$_',
        l = function(e) {
          return e && 'cn' === e.toLowerCase() ? s + '.google.cn' : a;
        },
        p = null,
        c = void 0,
        f = void 0,
        ...
        return p || (p = n(31)), e
          ? c
              ...
              : ((c = new Promise(function(n, o) {
                  ...
                  (0, i.default)(e.v) && (r += '&v=3.31');
                  var s = l(e.region), a = t ? '&libraries=visualization' : '';
                  p('' + s + u + r + a, function() {
