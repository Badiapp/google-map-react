  ...
  function GoogleMap(props) {
    ...
    _this._onDragStart = function() {
      ...
      return _this.props.onDragStart &&
        (_this$props3 = _this.props).onDragStart.apply(_this$props3, arguments);
    };

    _this._onDragEnd = function() {
      var _this$props4;

      return _this.props.onDragEnd &&
        (_this$props4 = _this.props).onDragEnd.apply(_this$props4, arguments);
    };
    ...
    _this._onMapTypeIdChange = function() {
      ...
      return _this.props.onMapTypeIdChange &&
        (_this$props5 = _this.props).onMapTypeIdChange.apply(
          _this$props5,
          arguments
        );
    };
    ...
    _this._onZoomAnimationStart = function() {
      ...
      return _this.props.onZoomAnimationStart &&
        (_this$props6 = _this.props).onZoomAnimationStart.apply(
          _this$props6,
          arguments
        );
    };
    ...
    _this._onZoomAnimationEnd = function() {
      ...
      return _this.props.onZoomAnimationEnd &&
        (_this$props7 = _this.props).onZoomAnimationEnd.apply(
          _this$props7,
          arguments
        );
    };
    ...
    _this._onChildClick = function() {
      if (_this.props.onChildClick) {
        ...
        return (_this$props8 = _this.props).onChildClick.apply(
          _this$props8,
          arguments
        );
      }
    ...
    _this._onChildMouseEnter = function() {
      if (_this.props.onChildMouseEnter) {
        ...
        return (_this$props11 = _this.props).onChildMouseEnter.apply(
          _this$props11,
          arguments
        );
      }
    ...
    _this._onChildMouseLeave = function() {
      if (_this.props.onChildMouseLeave) {
        ...
        return (_this$props12 = _this.props).onChildMouseLeave.apply(
          _this$props12,
          arguments
        );
      }
    ...
    _this._onClick = function() {
      ...
      return _this.props.onClick &&
        ...
        _this.dragTime_ === 0 &&
        (_this$props13 = _this.props).onClick.apply(_this$props13, arguments);
    };
